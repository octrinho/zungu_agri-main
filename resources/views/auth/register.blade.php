                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <select class="form-control select2 select2-hidden-accessible" style="width: 100%;" data-select2-id="1" tabindex="-1" aria-hidden="true" name="role">
                                <option selected="selected" value="2">Farmer</option>
                                <option value="3">Farm Owner</option>
                                <option value="4">Seed Supplier</option>
                                <option value="5">Pesticide Supplier</option>
                            </select>
                            </div>
                        </div>
